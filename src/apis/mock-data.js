export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'TranQuangHaoDEV',
    description: 'Hello, this is Hao',
    type: 'public', // 'private'
    ...
    columns: [
      ...
      },
      {
        ...
        cards: [
          {
            _id: 'column-id-04-placeholer-card',
            boardId: 'board-id-01',
            columnId: 'column-id-04',
            FE_PlaceholderCard: true
            // FE_PlaceholderCard phía FE sẽ tự tạo ra 1 card đặc biệt.
            // Card đặc biệt này sẽ được ẩn đi ở giao diện người dùng.
          }
        ]
      }
    ]
